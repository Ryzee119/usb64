...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "common.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (n64hal_millis())    /*Expression evaluating to current system time in ms*/
